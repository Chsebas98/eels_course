...
class UserCacheDto {
  ...
  const UserCacheDto(this.name, this.age, this.weight, this.email);

  factory UserCacheDto.fromEntity(UserModel entity) {
  ...
  Map toJson() => {'name': name, 'age': age, 'weight': weight, 'email': email};
}
